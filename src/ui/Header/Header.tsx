...
const txt = {
  fr: {
    ...
    gameAltLink: 'Accéder au contenu du jeu en version texte',
  },
  en: {
    logoMO5Alt: 'MO5 association',
    logoMJVLabel: 'Video Game Museum - Home',
    gameAltLink: 'Access the game content in text format',
  }
}
...
export const Header = (props: HeaderProps) => {
  ...
  return (
    <>
      ...
      <Show when={props.withGame}>
        <p class="relative z-10 my-0 px-4 text-xs text-center md:ms-6 md:text-left">
          <a href={`/${lang()}/game-alternative`}>{t().gameAltLink}</a>
        </p>
      </Show>
    </>
  )

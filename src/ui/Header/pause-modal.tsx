...
const txt = {
  ...
  en: {
    pause1: "Dear friends,",
    pause2:
      "Since March 8th, the MO5 association's video game museum has entered a transition phase. Long-planned renovations and upgrades to the building are scheduled to begin soon and will continue for several months.",
    pause3: "During this period, the museum is closed to the public.",
    pause4: "At this time, a reopening date cannot be announced.",
    ...
    pause7: "Find us at external events (festivals, conventions, etc.)",
    ...
    pause10: "Thank you for your understanding.",

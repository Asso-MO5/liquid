...
/* Can be used in Header to display a modal dialog with important information */
export const PauseModal = () => {
  ...
  return (
    <dialog class="max-h-[90vh] w-[98vw] md:w-[60vw] md:text-xl m-auto p-4 border bg-bg text-text overflow-y-scroll" id="dialog-pause">
      ...
      */}
      <h1 id="title-pause" class="text-text font-bold outline-0" tabindex="0">
        {t().pause1}
      </h1>
      <p>{t().pause2}</p>
      <p>{t().pause3}</p>

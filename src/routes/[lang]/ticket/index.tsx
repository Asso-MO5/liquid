    ...
    <>
      ...
      <main id="main" class="items-center justify-center relative overflow-y-auto flex flex-col gap-6 p-6 text-text">
        ...
        <div id="step-2">
          ...
          <Slots isFetching={slotsCtrl.isFetching()} slots={slotsCtrl.slots()} onSlotClick={slotsCtrl.onSlotClick} currentSlot={ticketStore.slot_start_time} labelId="select-slot-title" />
        </div>
        ...
        <div id="step-4" class="max-w-sm mx-auto lg:self-start">
          ...
          <div class="m-4 flex flex-col gap-4">
            <div class="grid grid-cols-[auto_1fr] items-center gap-2">
              <input
                ...
                onChange={() => paymentCtrl.setIHaveReadTheTermsAndConditions(!paymentCtrl.IHaveReadTheTermsAndConditions())}
              />
          ...
          <Show when={paymentCtrl.paymentButtonDisabled() && paymentCtrl.paymentButtonErrorMessage()}>
            <p class="text-error text-sm mt-2 text-center">{paymentCtrl.paymentButtonErrorMessage()?.[lang() as "fr" | "en"]}</p>
          </Show>
        </div>
        <Address />
      </main>

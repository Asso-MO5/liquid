...
const txt = {
  fr: {
    ...
    successDescription: "Votre paiement a été confirmé. Les codes cadeaux ont été envoyés à l'adresse email indiquée.",
    successToast: "Votre paiement a bien été confirmé.",
    cancelTitle: "Paiement annulé",
    cancelDescription: "Le paiement des cartes cadeaux a été annulé. Vous pouvez réessayer si vous le souhaitez.",
    confirming: "Confirmation de votre paiement en cours...",
    confirmError: "Une erreur est survenue lors de la confirmation du paiement. Si le problème persiste, contactez-nous.",
    missingCheckout: "Impossible de retrouver la session de paiement. Si vous avez été débité, contactez-nous.",
  },
  en: {
    successTitle: "Thank you for your gift card purchase",
    successDescription: "Your payment has been confirmed. The gift codes have been sent to the email address you provided.",
    ...
    confirmError: "An error occurred while confirming the payment. If the problem persists, please contact us.",
    missingCheckout: "We could not find the payment session. If you have been charged, please contact us.",
  },
}
...
const PurchaseGiftRoute = () => {
  ...
  const confirmPurchase = async () => {
    const checkoutId = typeof window !== "undefined" ? window.localStorage.getItem("museum_gift_codes_checkout_id") : null

...
export const DarkMode = () => {
  ...
  return (
    <button type="button" onClick={darkMode.toggleDarkMode} class="cursor-pointer border-transparent hover:bg-emerald-500/20" data-dark={darkMode.isDarkMode()} title={darkMode.isDarkMode() === 'dark' ? t().toLight : t().toDark}>

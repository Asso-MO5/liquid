  ...
  return (
    <div class="flex flex-col gap-2">
      <div class="flex flex-col gap-1">
        ...
        <input type="text" value={ticketStore.first_name} onInput={(e) => setTicketStore('first_name', e.currentTarget.value)} />
      </div>
      <div class="flex flex-col gap-1">
        <label>{ticketTxt.last_name[lang() as keyof typeof ticketTxt.last_name]}</label>
        <input type="text" value={ticketStore.last_name} onInput={(e) => setTicketStore('last_name', e.currentTarget.value)} />
      </div>
      <div class="flex flex-col gap-1">
